...
# Procedure:
 1. Go to the Directory for where you will be creating your new repository
 2. Open CLI in this new directory
 3. Run these repository init commands to clone this repo into that directory:
 4. [insert setup commands here]
 5. Add main.cc and readme.md to your .gitignore file
 6. Set your range of automated git commits on line [x] inside main.cc where designated
 7. Set your new github repository URL on line [x] inside main.cc where designated
